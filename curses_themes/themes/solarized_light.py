#!/usr/bin/env python3
"""
Solarized Light theme — precision colors by Ethan Schoonover.
...
class SolarizedLightTheme(Theme):
    ...
    component_colors = {
        "background": (BASE00, BASE3),
        "button": (BLUE, BASE2),
        "button_focused": (BASE3, BLUE),
        "text_input": (BASE01, BASE2),
        "border": (BASE1, BASE3),
        "selection": (BASE03, BASE2),
        "disabled": (BASE1, BASE3),
    }
    ...
    def __init__(self):
        super().__init__(
            ...
            description=(
                "Solarized Light palette by Ethan Schoonover. "
